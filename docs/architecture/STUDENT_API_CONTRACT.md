...
| 22 | Calendar | Event calendar | `GET /student/calendar` | GET | Sanctum + student.linked | `month?`, `year?`, `type?` | — | `month, year, events:[{id,title,description,event_type,start_date,end_date,is_published,location,audience}]` | 200, 401, 403, 404 | No | ✅ |
