...
@section('report_title', 'Overdue Fees Report')
...
<script type="text/javascript">
    $(function () {
        ...
        function updateExportLinks() {
            ...
            $('#exportExcel').attr('href', "{{ route('reports.fees.export.excel', 'overdue') }}?" + qs);
            $('#exportPdf').attr('href', "{{ route('reports.fees.export.pdf', 'overdue') }}?" + qs);
            $('#exportPrint').attr('href', "{{ route('reports.fees.print', 'overdue') }}?" + qs);
        }
