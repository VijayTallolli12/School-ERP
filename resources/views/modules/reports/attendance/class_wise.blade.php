            ...
            <form id="filterForm" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <x-erp.export-buttons 
                        excelUrl="{{ route('reports.attendance.class_wise.export.excel', request()->query()) }}"
                        pdfUrl="{{ route('reports.attendance.class_wise.export.pdf', request()->query()) }}"
                        printUrl="{{ route('reports.attendance.class_wise.print', request()->query()) }}"
                    />
                </div>
            </form>
