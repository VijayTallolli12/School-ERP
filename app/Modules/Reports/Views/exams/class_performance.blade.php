        ...
        <div class="col-md-12">
            <form id="filterForm" class="row g-3 align-items-end">
                ...
                <div class="col-auto mb-2">
                    ...
                    <a id="exportExcel" href="{{ route('reports.exams.export.excel', ['type' => 'class_performance']) }}" class="btn btn-success me-2"><i class="ti ti-file-spreadsheet me-1"></i>Export Excel</a>
                    <a id="exportPdf" href="{{ route('reports.exams.export.pdf', ['type' => 'class_performance']) }}" class="btn btn-danger me-2"><i class="ti ti-file-type-pdf me-1"></i>Export PDF</a>
                    <a id="exportPrint" href="{{ route('reports.exams.print', ['type' => 'class_performance']) }}" class="btn btn-warning" target="_blank"><i class="ti ti-printer me-1"></i>Print</a>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    $(async function () {
        ...
        var table = $("#performanceTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route("reports.exams.class_performance") }}",
                data: function (d) {
            ...
            columns: [
                ...
                {data: "average_percentage", name: "average_percentage"},
            ]
        });
        ...
        function updateExportLinks() {
            ...
            var baseExcel = "{{ route('reports.exams.export.excel', ['type' => 'class_performance']) }}";
            var basePdf = "{{ route('reports.exams.export.pdf', ['type' => 'class_performance']) }}";
            var basePrint = "{{ route('reports.exams.print', ['type' => 'class_performance']) }}";
