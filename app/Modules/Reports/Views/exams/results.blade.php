        ...
        <div class="col-md-12">
            <form id="filterForm" class="row g-3 align-items-end">
                ...
                <div class="col-auto mb-2">
                    ...
                    <a id="exportPrint" href="{{ route('reports.exams.print', ['type' => 'results']) }}" class="btn btn-sm btn-outline-secondary" target="_blank"><i class="ti ti-printer me-1"></i>Print</a>
                </div>
            </form>
        </div>
    </div>
