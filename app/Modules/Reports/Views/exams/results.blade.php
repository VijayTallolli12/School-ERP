    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <form id="filterForm" class="row g-3 align-items-end">
                ...
                <div class="col-auto mb-2">
                    <label for="subject_id" class="form-label me-2">Subject:</label>
                ...
                <div class="col-auto mb-2">
                    ...
                    <a id="exportExcel" href="{{ route('reports.exams.export.excel', ['type' => 'results']) }}" class="btn btn-success me-2"><i class="ti ti-file-spreadsheet me-1"></i>Export Excel</a>
                    <a id="exportPdf" href="{{ route('reports.exams.export.pdf', ['type' => 'results']) }}" class="btn btn-danger me-2"><i class="ti ti-file-type-pdf me-1"></i>Export PDF</a>
                    <a id="exportPrint" href="{{ route('reports.exams.print', ['type' => 'results']) }}" class="btn btn-warning" target="_blank"><i class="ti ti-printer me-1"></i>Print</a>
                </div>
            </form>
        </div>
    </div>
