        ...
        <div class="col-md-12">
            <form id="filterForm" class="row g-3 align-items-end">
                ...
                <div class="col-auto mb-2">
                    ...
                    <a id="exportExcel" href="{{ route('reports.exams.export.excel', ['type' => 'student_summary']) }}" class="btn btn-sm btn-outline-success me-2"><i class="ti ti-file-spreadsheet me-1"></i>Export Excel</a>
                    <a id="exportPdf" href="{{ route('reports.exams.export.pdf', ['type' => 'student_summary']) }}" class="btn btn-sm btn-outline-danger me-2"><i class="ti ti-file-type-pdf me-1"></i>Export PDF</a>
                    <a id="exportPrint" href="{{ route('reports.exams.print', ['type' => 'student_summary']) }}" class="btn btn-sm btn-outline-secondary" target="_blank"><i class="ti ti-printer me-1"></i>Print</a>
                </div>
            </form>
        </div>
    </div>
