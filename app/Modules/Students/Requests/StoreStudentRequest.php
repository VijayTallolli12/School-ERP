...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            'admission_no' => ['required', 'string', 'max:50', Rule::unique('students')->where('school_id', $schoolId)],
            ...
            'email' => ['nullable', 'required_if:create_user,1', 'email', 'max:255', 'unique:users,email'],
