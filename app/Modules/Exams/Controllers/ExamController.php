...
class ExamController extends Controller
{
    ...
    public function data(): JsonResponse
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('status_label', fn (Exam $exam) => '<span class="badge bg-'.($exam->status === 'scheduled' ? 'secondary' : ($exam->status === 'completed' ? 'success-subtle text-success' : 'danger-subtle text-danger')).'">'.e($exam->status_label).'</span>')
    ...
    public function resultsData(): JsonResponse
    {
        ...
        return DataTables::eloquent($query)
            ...
            ->addColumn('status_label', fn (ExamResult $result) => '<span class="badge bg-'.($result->status === 'pass' ? 'success-subtle text-success' : 'danger-subtle text-danger').'">'.e($result->status_label).'</span>')
