...
class UpdateSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'school.remove_logo' => ['nullable', 'boolean'],
            'school.favicon' => ['nullable', 'file', 'mimes:ico,png,jpg,jpeg,webp', 'max:1024'],
            'school.remove_favicon' => ['nullable', 'boolean'],
            'school.auth_background' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:5120'],
            'school.remove_auth_background' => ['nullable', 'boolean'],
            'school.auth_background_color' => ['nullable', 'string', 'max:500'],
            ...
            'school.primary_color' => ['nullable', 'string', 'regex:/^#[a-fA-F0-9]{6}$/'],
            'school.secondary_color' => ['nullable', 'string', 'regex:/^#[a-fA-F0-9]{6}$/'],
            'school.text_color' => ['nullable', 'string', 'regex:/^#[a-fA-F0-9]{6}$/'],
