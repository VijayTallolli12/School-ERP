...
class PermissionSeeder extends Seeder
{
    ...
    private function permissions(): array
    {
        $modules = [
            ...
            'payroll' => ['view', 'create', 'update', 'delete', 'export'],
    ...
    private function rolePermissions(): array
    {
        return [
            ...
            'Payroll Manager' => ['dashboard.view', 'payroll.view', 'payroll.create', 'payroll.update', 'payroll.delete', 'payroll.export', 'reports.view'],
