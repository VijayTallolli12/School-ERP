...
class PermissionSeeder extends Seeder
{
    ...
    private function permissions(): array
    {
        $modules = [
            ...
            'admissions' => ['view', 'create', 'update', 'delete', 'verify', 'approve', 'reject', 'convert'],
            'student_lifecycle' => ['view', 'promote', 'transfer', 'tc', 'alumni'],
            ...
            'transport' => ['view', 'create', 'update', 'delete', 'export', 'location.update'],
            ...
            'hr' => ['view', 'create', 'update', 'delete', 'verify'],
    ...
    private function rolePermissions(): array
    {
        return [
            ...
            'Principal' => [
                ...
                'reports.view',
                'leave_management.view', 'leave_management.approve', 'leave_management.create',
                'admissions.view', 'admissions.create', 'admissions.update', 'admissions.verify', 'admissions.approve', 'admissions.reject', 'admissions.convert',
                'student_lifecycle.view', 'student_lifecycle.promote', 'student_lifecycle.transfer', 'student_lifecycle.tc', 'student_lifecycle.alumni',
            ],
            'Teacher' => [
                'dashboard.view', 'students.view', 'academics.view', 'attendance.view',
                'attendance.create', 'attendance.update', 'attendance.reports', 'exams.view', 'exams.create', 'exams.update', 'exams.reports', 'timetable.view', 'timetable.reports',
                'academic_calendar.view', 'student_documents.view',
                'homework.view', 'homework.create', 'homework.update', 'homework.delete',
            ],
            'Student' => ['dashboard.view', 'attendance.view', 'fees.view', 'exams.view', 'notifications.view'],
            'Parent' => [
            ...
            'Payroll Manager' => ['dashboard.view', 'payroll.view', 'payroll.create', 'payroll.update', 'payroll.delete', 'payroll.export', 'payroll.process', 'payroll.lock', 'payroll.payslip.view', 'payroll.payslip.generate', 'payroll.payslip.export', 'reports.view'],
            'Receptionist' => ['dashboard.view', 'students.view', 'students.create', 'parents.view', 'parents.create', 'admissions.view', 'admissions.create', 'admissions.update', 'admissions.verify'],
            'HR' => ['dashboard.view', 'teachers.view', 'teachers.create', 'teachers.update', 'teachers.reports', 'reports.view',
                'hr.view', 'hr.create', 'hr.update', 'hr.delete', 'hr.verify',
            ],
